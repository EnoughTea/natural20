...
### Something simple: usual ability scores roll
Roll 4d6 for each of the six ability scores. Drop the low die in each roll.
	// Quick note: built-in dice get their random generator from Dice.Random. It's thread-local and you can change it.
